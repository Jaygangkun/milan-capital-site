    ...
    include('header.php');
    ?>
    <div class="home-hero bk-wrap header-over">
            ...
            <div class="home-hero-wrap">
                <div class="home-hero-menu">
                    <a class="home-hero-menu-link active">
                        ...
                        <span class="home-hero-menu-link__text">our dna</span>
                    </a>
                    ...
                    <a class="home-hero-menu-link">
                        ...
                        <span class="home-hero-menu-link__text">the firm</span>
                    </a>
                    <div class="home-hero-menu-link home-hero-menu-link--dots-only">
                        <img class="home-hero-slide-dot__img" src="images/3-dots.svg">
                    </div>
                    <a class="home-hero-menu-link">
                        ...
                        <span class="home-hero-menu-link__text">strategies</span>
                    </a>
                    <div class="home-hero-menu-link home-hero-menu-link--dots-only">
                        <img class="home-hero-slide-dot__img" src="images/3-dots.svg">
                    </div>
                ...
                <div class="home-hero-search-icon-wrap">
                    <img class="home-hero-search-icon-wrap-img" src="images/search-icon.svg">
                </div>
            </div>
        </div>
    </div>

    <div class="home-accelerated-innovation">
        <div class="container--large">
            <div class="home-accelerated-row">
                <div class="home-accelerated-col home-accelerated-col--left">
                    <div class="home-accelerated-note">
                        <h4 class="section-sub-title">ACCELERATED INNOVATION</h4>
                        <div class="home-accelerated-note-desc">We invest across the alternative asset classes in private equity, real estate, distressed debt, as well as in software infrastructure, education, automation, and operational software. </div>
                        <img class="home-accelerated-note-arrow-img" src="images/icon-arrow-down.png">
                    </div>
                </div>
                <div class="home-accelerated-col home-accelerated-col--right">
                    <div class="home-accelerated-result">
                        <div class="home-accelerated-result-row">
                            <div class="home-accelerated-result-row-wrap">
                                <div class="home-accelerated-result-number">$44MM+</div>
                                <div class="home-accelerated-result-name">ASSETS UNDER MANAGEMENT</div>
                            </div>
                        </div>
                        <div class="home-accelerated-result-row">
                            <div class="home-accelerated-result-row-wrap">
                                <div class="home-accelerated-result-number">200+</div>
                                <div class="home-accelerated-result-name">EMPLOYEES</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 mx-auto text-center">
                    <h2 class="home-dna-title">OUR DNA</h2>
                    ...
                    <div class="home-questions-list">
                        <div class="home-question-row">
                            <div class="home-question-header">
                                <div class="home-question-q-text">What kind of companies do you invest in?</div>
                                <img class="home-question-icon open" src="images/expand-icon-green.svg">
                                <img class="home-question-icon closed" src="images/expand-icon-white.svg">
                            </div>
                            <div class="home-question-body">
                                What kind of companies do you invest in? answer
                            </div>
                        </div>
                        <div class="home-question-row">
                            <div class="home-question-header">
                                <div class="home-question-q-text">What size companies do Milan Capital invest in?</div>
                                <img class="home-question-icon open" src="images/expand-icon-green.svg">
                                <img class="home-question-icon closed" src="images/expand-icon-white.svg">
                            </div>
                            <div class="home-question-body">
                                What size companies do Milan Capital invest in? answer
                            </div>
                        </div>
                        <div class="home-question-row">
                            <div class="home-question-header">
                                <div class="home-question-q-text">How do you determine the value of a company?</div>
                                <img class="home-question-icon open" src="images/expand-icon-green.svg">
                                <img class="home-question-icon closed" src="images/expand-icon-white.svg">
                            </div>
                            <div class="home-question-body">
                                How do you determine the value of a company? answer
                            </div>
                        </div>
                        <div class="home-question-row">
                            <div class="home-question-header">
                                <div class="home-question-q-text">How long does the transaction take?</div>
                                <img class="home-question-icon open" src="images/expand-icon-green.svg">
                                <img class="home-question-icon closed" src="images/expand-icon-white.svg">
                            </div>
                            <div class="home-question-body">
                                How long does the transaction take? answer
                            </div>
                        </div>
                        <div class="home-question-row">
                            <div class="home-question-header">
                                <div class="home-question-q-text">What role will I play after partnering with Milan Capital?</div>
                                <img class="home-question-icon open" src="images/expand-icon-green.svg">
                                <img class="home-question-icon closed" src="images/expand-icon-white.svg">
                            </div>
                            <div class="home-question-body">
                                What role will I play after partnering with Milan Capital? answer
                            </div>
                        </div>
                    </div>
                </div>
