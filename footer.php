<footer>
        <div class="footer-top">
            <div class="container--large">
                <div class="row">
                    <div class="col-lg-3 footer-top-col footer-top-col-logo">
                    ...
                    <div class="col-lg-3 footer-top-col footer-top-col-socials">
                        <div class="footer-social-title">SOCIAL MEDIA</div>
                        <div class="footer-social-links">
                            <a class="footer-social-link">
                                <img class="footer-social-icon__img" src="images/facebook-icon.svg">
                            </a>
                            <a class="footer-social-link">
                                <img class="footer-social-icon__img" src="images/youtube-icon.svg">
                            </a>
                            <a class="footer-social-link">
                                <img class="footer-social-icon__img" src="images/instagram-icon.svg">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6 mx-auto">
                        <div class="footer-subscribe-form">
                            ...
                            <div class="footer-subscribe-form-wrap">
                                ...
                                <div class="footer-subscribe-form-btn">SUBMIT</div>
                            </div>
                        </div>
                    </div>
                </div>
